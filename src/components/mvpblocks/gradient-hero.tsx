      ...
      <div className="container relative z-10 mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <motion.h1
            ...
            className="bg-gradient-to-tl from-primary/10 via-foreground/85 to-foreground/50 bg-clip-text text-center text-4xl tracking-tighter text-transparent sm:text-5xl md:text-6xl lg:text-7xl"
          >
            Review Kenyan Legal Contracts Instantly with AI
          </motion.h1>
          ...
          >
            Upload employment, lease, or service agreements and get
            clause-by-clause summaries, risk alerts, and legal context — all
            tailored for Kenya. Save time. Spot red flags. Stay protected.
          </motion.p>
